"""
tests/V6_5/test_mcp_search_service_mcp4.py

AutoSearch V6.5

MCP-4.2

MCP SearchService Test
...
def main():
    ...
    try:
        ...
        rows_without_source = service.search(
            TEST_QUERY
        )

        rows_with_source = service.search(
            TEST_QUERY,
            source="TSMC"
        )
        ...
        article = service.find_by_document_id(
            TEST_DOCUMENT_ID
        )
    ...
    print(
        "MCP-4.2 SearchService Test Summary"
    )
    print(
        "=========================================="
    )
    ...
    if failed == 0:
        ...
        print(
            "ALL MCP SEARCH SERVICE MCP-4.2 "
            "TESTS PASSED"
        )
